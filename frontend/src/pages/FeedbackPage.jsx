      ...
      >
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#2c5f7a] rounded-xl flex items-center justify-center shadow-lg shadow-lg">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <button onClick={() => navigate('/teacher/dashboard')} className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-[#2c5f7a] w-full transition-all font-medium">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
            </svg>
            Dashboard
          </button>
          <button className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#f5f7f9] text-[#2c5f7a] w-full transition-all font-medium shadow-sm">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#8ba3b5] to-[#4a7a94] rounded-full flex items-center justify-center text-white font-bold shadow-md">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b bg-gray-50">
                  ...
                  {submission.fileUrl && (
                    <a 
                      ...
                      className="text-sm text-[#2c5f7a] hover:text-[#1a3a52] font-medium flex items-center gap-1"
                    >
                      Open in new tab
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center bg-white rounded-xl border-2 border-dashed border-gray-200">
                        ...
                        {submission.fileUrl && (
                          <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="px-6 py-3 bg-[#2c5f7a] text-white rounded-xl font-medium hover:bg-[#1a3a52] transition-colors shadow-lg shadow-lg"
                          >
                            Download File
                          </a>
                        )}
            ...
            >
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div className="flex items-center gap-4 mb-4">
                  {submission.student?.avatar || submission.studentAvatar ? (
                    <img 
                      src={getFileUrl(submission.student?.avatar || submission.studentAvatar)} 
                      alt="avatar" 
                    ...
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#4a7a94] to-[#4a7a94] flex items-center justify-center text-white font-bold text-xl shadow-md">
                      {(submission.studentName || submission.student?.name || 'S').charAt(0).toUpperCase()}
                    </div>
                  )}
                  <div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      placeholder="0" 
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4a7a94] focus:border-[#4a7a94] text-lg font-semibold" 
                    />
                ...
                <div className="mb-8">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4a7a94] focus:border-[#4a7a94] resize-none" 
                  />
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    onClick={handleSave} 
                    disabled={saving} 
                    className="flex-1 bg-gradient-to-r from-[#2c5f7a] to-[#4a7a94] hover:from-[#1a3a52] hover:to-[#4a7a94] text-white px-4 py-3 rounded-xl font-bold shadow-lg shadow-lg disabled:opacity-60 disabled:shadow-none transition-all"
                  >

...
import { getAssignments, getSubmissions, getUsers, getConversations, markMessagesAsRead } from "../services/api";
...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      getConversations().then(c => setConversations(c || [])).catch(() => {});
    }, 5000);
    ...
    <StudentLayout>
      <div className="p-4 lg:p-8 space-y-8">
        ...
        <motion.div 
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white shadow-xl"
        >
          <div className="relative z-10">
            <h1 className="text-3xl font-bold mb-2">Welcome back, {user.name}! 👋</h1>
            <p className="text-blue-100 text-lg max-w-2xl">
              You have {assignments.length} active assignments. Keep up the great work!
            </p>
          </div>
                  ...
                  {filteredTeachers.length === 0 ? (
                    ...
                    filteredTeachers.map(teacher => (
                      ...
                      >
                        ...
                        <div>
                          <p className="font-bold text-gray-900 group-hover:text-blue-700 transition-colors">{teacher.name}</p>
